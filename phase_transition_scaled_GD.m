...
empir_probs_scaledGD_r_vs_s = zeros(6,6);

fileName = sprintf('data_empir_probs_scaledGD_r_vs_s_%d_%s.mat', n, datetime);
...
for  ii = 1:6
    for jj = 1:6
        ...
        empir_probs_scaledGD_r_vs_s(ii,jj) = sucind/20; 
        if empir_probs_scaledGD_r_vs_s(ii,jj) ==0
            for jjj = jj+1:6
                empir_probs_scaledGD_r_vs_s(ii,jjj) = 0;
            end
            break;
        end
    end
...
save(fileName, 'empir_probs_scaledGD_r_vs_s')
